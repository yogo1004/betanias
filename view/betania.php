...
<table class="table table-striped ">
  ...
  <?php foreach($newList[$key] as $meeting){ ?>
    <tr>
      ...
      <td><a type=button href="index.php?action=editMeetingPage&id_meeting=<?=$meeting['id_meeting']?>&id_betania=<?=$betania['id_betania']?>" class="btn btn-success">Edit <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
